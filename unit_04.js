...
const f1 = () => {
    let v = document.querySelector('.i-1').value
    a1.unshift(v)
    console.log(a1)
}
...
const f2 = () => {
    let v = +document.querySelector('.i-2').value
    a2.unshift(v, v**3)
    console.log(a2)
}
...
const f3 = () => {
    let v = document.querySelector('.i-3').value
    a3.unshift(v);
    console.log(a3);
    console.log(a3.unshift(v)) // Возвращает длину массива
    // ваш код
...
const f4 = () => {
    console.log(a4)
    console.log(a4.shift()) // Возвращает первый удаленный элемент
}

// TASK 05
// По нажатию b-5 выполняется функция f5. Функция удаляет из массива нулевое значение с помощью shift и возвращает результат операции.
