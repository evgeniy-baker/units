...
function t1() {
    const out = document.querySelector('.div-1').innerHTML;
...
// Task 14 ============================================
/*  Дан блок .div-14. При нажатии кнопки b-14 добавляйте к нему событие onclick - которое, при клике добавляем блоку 
div-14 класс active. */
...
function t15() {
    document.querySelector('.div-15').innerText++;
}
// ваше событие здесь!!!
...
function t16() {
    ...
    document.querySelector('.div-16').style.width ++;
}
...
function t18() {
    document.querySelector('.div-18').style.width = 75 + 'px'
    document.querySelector('.out-18').innerHTML = document.querySelector('.div-18').style.width;
}
// ваше событие здесь!!!
document.querySelector('.div-18').onmouseout = t18!!!
...
function t19() {
    document.querySelector('.out-19').innerHTML = document.querySelector('.div-19').className;
}
// ваше событие здесь!!!
