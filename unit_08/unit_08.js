...
function t11() {
    ...
    let values = document.querySelectorAll('.div-11');
    let i = 0;
    let string = '';
    while (i < values.length) {
        string += values[i].innerHTML + ' ';
        i++;
    }
    out.innerHTML = string;
}
...
function t12() {
    let values = document.querySelectorAll('.div-12');
    let i = 0;
    while (i < values.length) {
        values[i].style.background = 'orange';
        i++;
    }
}
...
function t13() {
    let values = document.querySelectorAll('.i-13');
    let i = 0;
    while (i < values.length) {
        values[i].value = i + 1;
        i++;
...
function t14() {
    ...
    let values = document.querySelectorAll('.i-14');
    let i = 0;
    let string = '';
    while (i < values.length) {
        if (values[i].checked) {
