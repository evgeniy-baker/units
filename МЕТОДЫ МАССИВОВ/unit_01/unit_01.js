// TASK 01
// По нажатию b-1 выполняется функция f1. Функция считывает значение из i-1 и с помощью indexOf и ищет данный 
// элемент в массиве a1. Выводит в out-1 результат работы.
...
const f1 = () => {
    ...
    document.querySelector('.out-1').innerHTML = a1.indexOf(num)
}

// TASK 02
// По нажатию b-2 выполняется функция f2. Функция считывает значение из i-2 и с помощью indexOf и ищет 
// данный элемент в массиве a2. Выводит в out-2  false, если такого элемента нет в массиве, и ИНДЕКС элемента если есть.
...
const f2 = () => {
    ...
    document.querySelector('.out-2').innerHTML = a1.indexOf(num)
}

// TASK 03
// По нажатию b-3 выполняется функция f3. Функция считывает значение из i-3 и с помощью indexOf и ищет данный элемент 
// в массиве a3. Выводит в out-3  false, если такого элемента нет в массиве, и true если есть.
// Как тестируется - ввожу числа и проверяю результат.
...
const f3 = () => {
    let num = +document.querySelector('.i-3').value
    if (a1.indexOf(num) === -1) return document.querySelector('.out-3').innerHTML = false
    else return document.querySelector('.out-3').innerHTML = a1.indexOf(num)
}
...
// если элемента в массиве нет. Протестируйте задачу на строке '2' и числе 2. Сделайте выводы.
...
const f4 = () => {
    ...
    document.querySelector('.out-4').innerHTML = a4.indexOf(elem);
}

// TASK 05
// По нажатию b-5 выполняется функция f5. Функция считывает значение из i-5-1 и индекс с которого начинается 
// поиск в массиве с i-5-2 и с помощью indexOf и ищет данный элемент в массиве a5 c позиции указанной в i-5-2. 
...
const f5 = () => {
    let elem = +document.querySelector('.i-5-1').value;
    let poz = +document.querySelector('.i-5-2').value;
    document.querySelector('.out-5').innerHTML = a5.indexOf(elem, poz);
}

// TASK 06
// По нажатию b-6 выполняется функция f6. Функция считывает значение из i-6 и с помощью indexOf и ищет данный элемент 
// в СТРОКЕ a6. Выводит в out-6 результат поиска.
...
const f6 = () => {
    let item = document.querySelector('.i-6').value;
    let spl = a6.split('');
    document.querySelector('.out-6').innerHTML = spl.indexOf(item);
}
