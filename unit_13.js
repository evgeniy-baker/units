// Task 1
// При нажатии b-1 выполняете функцию f1. Функция должна вывести в out-1 значение сохраненное под ключем two 
// из массива a1. Возвратите это значение. Первая задача дана в качестве примера.
...
// Возвратите это значение. Вывод, как и в предыдущем задании пишем "руками"
...
// Возвратите это значение. Вывод - через пробел. Вывод, как и в предыдущем задании пишем "руками"
...
// Формат вывода - ключ пробел значение перенос строки +' <br>'. Функция должна возвращать строку 
// в указанном формате вывода. Обратите внимание на пробел перед br!!!!!!!!!
...
function f7() {
    ...
    if (key in a7 === true) document.querySelector('.out-7').innerHTML = 1;
    else document.querySelector('.out-7').innerHTML = 0;
}
...
function f8() {
    ...
    if (key in a7 === true) document.querySelector('.out-8').innerHTML = a8[key];
    else document.querySelector('.out-8').innerHTML = 0;
}
...
// которые содержат значение, равное значению в input.i-9. Вывод через пробел. 
...
// Фукнция должна возвращать true если есть, и false если нет. Массив и значение передавать функции 
// в качестве параметров.

function f10(arr, val) {
    for (let key in arr) {
        if (val === arr[key]) return true;
        else return false;
    }
    //return true;
    //return false;
...
function f12() {
    ...
    for (let key in a12) {
        if (a12[key] == value) delete a12[key]
    }
    f5(a12, '.out-12');
}
...
function f15() {
    ...
    document.querySelector('.out-15').innerHTML = string;
}
